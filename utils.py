...
class_names = ['carbonated-sd', 'competitor carbonated-sd', 'competitor energy', 'competitor fruit-juice', 'competitor water', 'energy', 'fruit-juice', 'water']
...
def draw_boxx(image, boxes, scores, mask_alpha=0.3):
    mask_img = image.copy()
    det_img = image.copy()
